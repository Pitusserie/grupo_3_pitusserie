/*----- constants -----*/
var bombImage = '<img src="img/errorimg/bomb.png">';
var flagImage = '<img src="img/errorimg/flag.png">';
var wrongBombImage = '<img src="img/errorimg/wrong-bomb.png">'
var sizeLookup = {
...
function buildTable() {
  ...
  <tr>
    <td class="menu" id="window-title-bar" colspan="${size}">
      <div id="window-title"><img src="img/errorimg/mine-menu-icon.png"> Busca Errores</div>
      <a href="/" ><div id="window-controls"><img src="img/errorimg/window-controls.png"></div></a>
    </td>
  </tr>
    <tr>
      <td class="menu" colspan="${size}">
          <section id="status-bar">
            ...
            <div id="reset"><img src="img/errorimg/smiley-face.png"></div>
...
function render() {
  ...
  if (hitBomb) {
    document.getElementById('reset').innerHTML = '<img src=img/errorimg/dead-face.png>';
    runCodeForAllCells(function(cell) {
    ...
    document.getElementById('reset').innerHTML = '<img src=img/errorimg/cool-face.png>';
    clearInterval(timerId);
  }
};
